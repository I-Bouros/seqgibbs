...
def run_unit_tests():
    ...
    """
    tests = os.path.join('seqgibbs', 'tests')
...
#"""
    ...
    for dirname, subdir_list, file_list in os.walk('seqgibbs'):
...
def doctest_rst_and_public_interface():
    ...
    # Import all public seqgibbs modules. We list
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Run unit test for seqgibbs',
        epilog='To run individual unit tests, use e.g.'
               ' $ python3 seqgibbs/tests/test_dummy.py',
    )
    # Unit tests
    parser.add_argument(
        '--unit',
